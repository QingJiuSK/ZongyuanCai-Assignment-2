...
public class ProductivityAppTest {
    ...
    class Getters {
        ...
        void getAppSize(){
            ...
            assertEquals(1001,productivityAppAboveBoundary.getAppSize());
            assertEquals(-1,productivityAppInvalidData.getAppSize());
        }
        ...
        void getAppVersion(){
            ...
            assertEquals(0.0,productivityAppInvalidData.getAppVersion());
        }
        ...
        void getAppCost(){
            ...
            assertEquals(-1,productivityAppInvalidData.getAppCost());
        }
    }
    ...
    class Setters{
        ...
        void setAppSize() {
            ...
            assertEquals(1001, productivityAppBelowBoundary.getAppSize()); //no update
            ...
            assertEquals(0, productivityAppBelowBoundary.getAppSize()); //no update
        }
        ...
        void setAppVersion() {
            ...
            assertEquals(0.0, productivityAppBelowBoundary.getAppVersion()); //no update
