...
public class EducationAppTest {
    ...
    void setUp() {
        ...
        edAppAboveBoundary = new EducationApp(developerLego, "EV3", 0, 3.5, 2.99, 0);
        edAppInvalidData = new EducationApp(developerLego, "", -1, 0, 0.00,0);
    }
    ...
    class Setters {
        ...
        void setLevel() {
            ...
            assertEquals(11, edAppBelowBoundary.getLevel()); //no update
