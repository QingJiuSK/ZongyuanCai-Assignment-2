...
public class GameAppTest {
    ...
    void setUp() {
        ...
        edAppBelowBoundary = new GameApp(developerLego, "WeDo", 1, 1.0, 0, false);
    ...
    class Getters {
        ...
        void getAppSize() {
            ...
            assertEquals(-1, edAppInvalidData.getAppSize());
        }
        ...
        void getAppVersion() {
            ...
            assertEquals(0.0, edAppInvalidData.getAppVersion());
        }
        ...
        void getAppCost() {
            ...
            assertEquals(-1, edAppInvalidData.getAppCost());
        }
    ...
    class Setters {
        ...
        void setAppVersion() {
            ...
            assertEquals(0.0, edAppBelowBoundary.getAppVersion()); //no update
        ...
        void set() {
            ...
            assertEquals(false, edAppBelowBoundary.getMultiplayer());

            edAppBelowBoundary.setMultiplayer(false);
            assertEquals(false, edAppBelowBoundary.getMultiplayer()); //update

            edAppBelowBoundary.setMultiplayer(false);
            assertEquals(false, edAppBelowBoundary.getMultiplayer()); //no update
    ...
    class ObjectStateMethods {
        ...
        void appSummaryReturnsCorrectString() {
            GameApp edApp = setupGameAppWithRating(3, 4);
    ...
    class RecommendedApp {
        ...
        void appIsNotRecommendedWhenRatingIsLessThan3AndAHalf() {
            ...
            GameApp edApp = setupGameAppWithRating(3, 3);
    ...
    GameApp setupGameAppWithRating(int rating1, int rating2) {
        ...
        GameApp edApp = new GameApp(developerLego, "WeDo", 1, 1.0, 1.00, true);
